...
if(!function_exists('strcode2utf')){ 
  function strcode2utf($str,$lo=true) {
	...
	//$str = preg_replace('/\&\#([0-9]+)\;/me', "code2utf('\\1',{$lo})",$str);   // revisar aca +++
	//$str = preg_replace_callback('/\&\#([0-9]+)\;/me', "code2utf('\\1',{$lo})",$str);
	//$str = preg_replace_callback('/\&\#([0-9]+)\;/me', //"code2utf('\\1',{$lo})",$str);
	
	//$str = preg_replace('/\&\#x([0-9a-fA-F]+)\;/me', "codeHex2utf('\\1',{$lo})",$str);
	//$str = preg_replace_callback('/\&\#x([0-9a-fA-F]+)\;/me', "codeHex2utf('\\1',{$lo})",$str);
