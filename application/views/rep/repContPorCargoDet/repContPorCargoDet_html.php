		...
		<tbody>			
			...
			<tr>
				...
				?>
					...
					<td class="textCenter">
						<input type="hidden" name="planilla<?php echo $itemTabla[0]; ?>" id="planilla<?php echo $itemTabla[0]; ?>" 
					...
					<td class="textCenter">
						<input type="hidden" name="votos<?php echo $itemTabla[0]; ?>" id="votos<?php echo $itemTabla[0]; ?>" 
							value="<?php echo $itemTabla[4]; ?>" />
						<?php echo $itemTabla[4]; ?>
					</td>
					<td class="textCenter">
						<input type="hidden" name="pcntj<?php echo $itemTabla[0]; ?>" id="pcntj<?php echo $itemTabla[0]; ?>" 
							value="<?php echo $itemTabla[5]; ?>" />
						<?php echo $itemTabla[5]; ?> %
					</td>
				<?php
						} 
					} 
