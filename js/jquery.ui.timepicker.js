...
(function ($) {
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            amPmText: ['A.M.', 'P.M.'],     // Display text for AM PM
            closeButtonText: 'Hecho',        // Text for the confirmation button (ok button)
            nowButtonText: 'Ahora',           // Text for the now button
            deselectButtonText: 'Limpiar'  // Text for the deselect button
        };
